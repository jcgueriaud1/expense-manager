---
name: visual-verdict
description: "Structured visual QA verdict for screenshot-to-reference comparisons. Use when a task has visual-fidelity requirements and you have a generated screenshot plus at least one reference image, and you need a deterministic pass/fail before continuing edits."
argument-hint: "[reference image(s) + generated screenshot]"
---

## Purpose

Compare generated UI screenshots against one or more reference images and return
a strict JSON verdict that can drive the next edit iteration.
